...
from mgraph_ai_service_github_digest.fast_api.routes.Routes__Threat_Intelligence import ROUTES_PATHS__THREAT_INTELLIGENCE
...
class test_Service__Fast_API__client(TestCase):
    ...
    def test__client__root_path(self):
        ...
        assert response__with_auth.json()    == {'version': version__mgraph_ai_service_github_digest }
