...
from mgraph_ai_service_github_digest.fast_api.routes.Routes__GitHub__API import GIT_HUB__API__DEFAULT__OWNER, \
    GIT_HUB__API__DEFAULT__REPO, GIT_HUB__API__DEFAULT__REF, GIT_HUB__API__DEFAULT__FILTER_STARTS_WITH, \
    GIT_HUB__API__DEFAULT__FILTER_CONTAINS, GIT_HUB__API__DEFAULT__FILTER_ENDS_WITH
